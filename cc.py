...
BOT_TOKEN = "8132478896:AAG3loZzimyOlbuyjiscLeCoxpjb1IMAVFY"
...
async def handle_text_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Kiểm tra nếu là group chat - chỉ xử lý khi bot được mention hoặc reply trực tiếp
    if is_group_chat:
        # Group chat - chỉ xử lý nếu bot được mention
...
async def handle_document(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Kiểm tra nếu là group chat - chỉ xử lý khi bot được mention hoặc reply trực tiếp
    if is_group_chat:
        # Group chat - chỉ xử lý nếu bot được mention hoặc reply vào bot
